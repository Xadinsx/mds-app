...
import { Button, Grid, LinearProgress, TextField, Typography, withStyles } from '@material-ui/core';
  ...
  renderPageContent = () => {
    ...
    return (
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Typography className={classes.subtitleText}>{step.subtitle}</Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography>{step.tips}</Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography className={classes.subtitleText}>{'Questões'}</Typography>
        </Grid>
